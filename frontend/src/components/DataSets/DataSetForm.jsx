// // src/components/DataSets/DataSetForm.jsx
...
//   anagrafica: { ANSERIALE: "", ANCOGNOM: "", AN_NOME: "", ANCODNAZ: "", AN_SESSO: "", ANDATNAS: "", ANCOMNAS: "", ANLOCNAS: "", ANPRONAS: "", ANESTNAS: "", ANNAZNAS: "", ANCODFIS: "", ANFLGCFM: "", ANPARIVA: "", ANISCRIT: "", AN_NOTE: "", ANTITOLO: "", ANLIBERO: "", ANDATVAR: "", ANNUSSIG: "", ANDATSIG: "", ANDTRESI: "", ANCODCON: "", ANATTENZ: "", ANCODOPE: "", ANDTVRAN: "", ANMATCAS: "", ANDTEIC: "", ANDTDLCC: "", ANFLGSOS: "", ANDTSOSP: "", ANMOSOSP: "", ANPRIVAC: "", ANDATPRV: "", ANAUTTR: "", ANDTAUTR: "", ANDTSCPE: "", ANFLGING: "", ANCODCEC: "", ANOLD_CF: "", ANDTEXCF: "", ANNOEXPO: "", ANIDANPR: "" },
//   recapiti: [{ ANTIPIND: "", ANINDIRI: "", AN_CAP: "", ANCODCOM: "", ANLOCALI: "", ANPROVIN: "", ANNAZION: "", ANTELEFO: "", ANTELFAX: "", ANPUBWEB: "" }],
//   contatti: [{ ANTIPCON: "", ANDESCON: "", ANPUBWEB: "" }],
//   attivita_professionale: [{ ANCODATT: "", ANDESATT: "", ANDTINAP: "", ANDTIFAP: "", ANCONSSN: "", ANREGPRO: "", ANDATSSN: "", ANDIP_PA: "", ANCODCON: "", ANDICCAT: "", ANDIPORA: "", ANDIPCON: "", ANDICCNL: "", ANDIPCOO: "", ANDIPDIR: "", ANESEPRO: "" }],
...
// const DataSetForm = ({ ordineId, fetchOrdine, closeForm }) => {
...
//   try {
//     // Envoi du nouveau DataSet
//     const response = await axios.post(
//       `http://localhost:3000/api/ordini/${ordineId}/addDataSet`,
//       { newDataSet: dataSet }, // envoi un nouvel objet DataSet
//       { headers: { Authorization: `Bearer ${token}` } }
//     );

//     console.log("DataSet ajouté :", response.data);
//     alert("✅ DataSet ajouté avec succès !");
//     fetchOrdine(); // rafraîchir la liste
//     if (closeForm) closeForm(); // fermer le formulaire
//   } catch (err) {
//     console.error("Erreur lors de l'ajout :", err.response || err);
//     alert(err.response?.data?.message || "Erreur lors de l'ajout du DataSet");
//   }
// };
...
//       <h3 className="text-2xl font-bold text-center text-green-700 mb-4">Aggiungi DataSet</h3>
...
//           >
//             {step === steps.length - 1 ? "Aggiungi DataSet" : "Avanti"}
//           </button>
//         </div>
//       </form>
//     </div>
...
ANFLITA: [
  ...
  // Champs à traiter comme date
  const dateFields = ["ANDATNAS","ANDTRESI", "ANDTVRAN","ANDATVAR","ANDATSIG","ANDTSOSP","ANDATPRV","ANDTAUTR","ANDTSCPE","ANDTEXCF","ANDTINAP","ANDTIFAP","ANDATSSN","ANDTINSA","ANDTFISA","ANDATISC","ANDATPIS","ANDATCAN","ANDATDEC","ANDTISNO","ANDTDECA","ANDATABI","ANDATARV","ANDATTIT","ANDRITCL"];
  ...
  return (
    <div className="max-w-4xl mx-auto my-6 bg-white shadow-2xl rounded-3xl p-6 flex flex-col h-[80vh]">
      {/* Titre */}
      ...
      {/* Steps - Sticky */}
      <div className="flex flex-wrap justify-center gap-2 mb-4 sticky top-6 bg-white z-10 py-2 rounded-xl shadow">
        {steps.map((label, index) => (
          <button
            key={index}
            type="button"
      ...
      <form
        ...
        className="flex-1 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-green-300 scrollbar-track-green-100"
      >
        <AnimatePresence mode="wait">
          <motion.div
            key={step}
        ...
        <div className="flex justify-between mt-6 sticky bottom-0 bg-white py-4 shadow-inner rounded-b-3xl">
          {step > 0 && (
            <button
              type="button"
              onClick={() => setStep(step - 1)}

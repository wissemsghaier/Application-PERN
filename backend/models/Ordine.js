  ...
  titoli: [
    {
      ...
      ANLODTIT: { type: String },
      ANNTIT: { type: Number },
      ANCLASSE: { type: Number },
      ANDICRIS: { type: String },
      ANDRITCL: { type: Date },
      ANCARICL: { type: String },
      ANFLITA: { type: Boolean },
      ANRIMTI: { type: Boolean },
      ANRICUTI: { type: Boolean },
      ANTIVVER: { type: Boolean },
    },
  ],
